...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x40DB // Searching for mon
#define DN_FLAG_DEXNAV_GET            0x498 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x499 // Allow player to find hidden mons
