...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_FOLLOWERS_ON_0x494          // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
...
#define OW_FLAG_POKE_RIDER          FLAG_ENABLE_POKE_RIDER_0x274  // If this flag is set, the player will be able to use fly from the Pokenav Region Map and the Town Map key item by pressing 'R' on a city/location they are able to fly to.
