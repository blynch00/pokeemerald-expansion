...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .baseDefense   = 50,
        .baseSpeed     = 80,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 105 : 90,
        .baseSpDefense = 50,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .abilities = { ABILITY_PLUS, ABILITY_NONE, ABILITY_MAGNET_PULL },
    #else
    ...
    [SPECIES_HUNTAIL] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_NONE, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_NONE, ABILITY_DAZZLING },
        .bodyColor = BODY_COLOR_PINK,
