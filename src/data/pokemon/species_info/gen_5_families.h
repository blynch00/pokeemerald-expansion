...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    {
        .baseHP        = 90,
        .baseAttack    = P_UPDATED_STATS >= GEN_6 ? 115 : 100,
        .baseDefense   = 90,
        .baseSpeed     = 80,
        .baseSpAttack  = 45,
        .baseSpDefense = 90,
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT},
                                {EVO_LEVEL, 36, SPECIES_LILLIGANT_HISUI}),
    },
    ...
    [SPECIES_LILLIGANT_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_HUSTLE, ABILITY_CHLOROPHYLL },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Lilligant"),
        .cryId = CRY_LILLIGANT,
    ...
    [SPECIES_BASCULIN_RED_STRIPED] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_TORRENT, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_MALE, 36, SPECIES_BASCULEGION_M},
                                {EVO_LEVEL_FEMALE, 36, SPECIES_BASCULEGION_F}),
    },
    ...
    [SPECIES_BASCULEGION_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_TORRENT, ABILITY_SWIFT_SWIM, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    {
        .baseHP        = 95,
        .baseAttack    = P_UPDATED_STATS >= GEN_7 ? 140 : 110,
        .baseDefense   = 80,
        .baseSpeed     = 50,
        .baseSpAttack  = 70,
        .baseSpDefense = 80,
