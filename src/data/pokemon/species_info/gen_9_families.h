...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPIDOPS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_POISON_POINT, ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_NONE, ABILITY_MYCELIUM_MIGHT },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BOMBIRDIER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_OVERCOAT, ABILITY_ROCKY_PAYLOAD, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
